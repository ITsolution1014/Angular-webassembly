...
export class Wasm3dCubeComponent extends EmscriptenWasmComponent {
  ...
  constructor(private httpClient: HttpClient, private ngZone: NgZone) {
    ...
    this.moduleDecorator = (mod) => {
      ...
      mod.print = (what: string) =>{
        this.ngZone.run(()=>console.log(what));
      }
    ...
    // var image = new Image();
    // image.src = 'https://4.bp.blogspot.com/_SWF9i3Vzpac/TLnUZJI_EAI/AAAAAAAAAwE/LDmlfrNc6ZQ/s1600/Strutting+Leo-original+meme.jpg';
  ...
  //         image.onload = function () {
  //               canvasContext.drawImage(image, 0, 0,300,300);
  //         };
  //         this.tmp = can;
